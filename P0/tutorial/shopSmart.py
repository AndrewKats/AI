...
# Helper function for finding an order cost for a given shop
...
def shopSmart(orderList, fruitShops):
    ...
    for shop in fruitShops:
      newCost = buyFruitFromShop(orderList, shop)
      # If we found a better new cost, make it the best cost and shop
      if newCost and newCost < minCost:
        minCost = newCost
        bestShop = shop
    return bestShop
